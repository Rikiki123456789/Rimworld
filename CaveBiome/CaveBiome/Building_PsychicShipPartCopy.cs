...
namespace CaveBiome
{
    ...
    public class Building_PsychicShipPartCopy : Building_CrashedShipPartCopy
    {
        ...
        {
            base.SpawnSetup(map);
            this.ticksToInsanityPulse = Building_PsychicShipPartCopy.InsanityPulseInterval.RandomInRange;
