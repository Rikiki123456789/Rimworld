...
namespace OutpostGenerator
{
    ...
    public class JobDriver_CleanOutpost : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            }.WithEffect("Clean", filthIndex).WithProgressBar(filthIndex, () => this.totalCleaningWorkDone / this.totalCleaningWorkRequired, true, -0.5f).WithSustainer(() => SoundDefOf.Interact_CleanFilth);
