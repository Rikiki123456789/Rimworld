...
namespace OutpostGenerator
{
    ...
    {
        // This workgiver is specific to M&Co. employees. When a supply ship is landed (so there is a cryptosleep bay),
        // it will order a pawn to open a used medibay cryptosleep casket so its content (a downed M&Co. employee)
