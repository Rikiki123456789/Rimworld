...
namespace ForceField
{
    ...
    public class Building_ForceFieldGenerator : Building
    {
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            this.forceFieldMatrix.SetTRS(this.Position.ToVector3ShiftedWithAltitude(AltitudeLayer.MoteOverhead) + new Vector3(0f, 0f, 0.5f).RotatedBy(this.Rotation.AsAngle), this.Rotation.AsAngle.ToQuat(), forceFieldScale);
            this.forceFieldAbsorbtionMatrix.SetTRS(this.Position.ToVector3ShiftedWithAltitude(AltitudeLayer.MoteOverhead) + new Vector3(0f, 0f, 0.5f).RotatedBy(this.Rotation.AsAngle), this.Rotation.AsAngle.ToQuat(), forceFieldScale);
        }
