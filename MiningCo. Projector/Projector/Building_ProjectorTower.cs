...
namespace Projector
{
    ...
    public class Building_ProjectorTower : Building_Projector
    {
        // ===================== Variables =====================
        ...
        /// </summary>
        public override void SpawnGlower(IntVec3 position, Map map)
        {
            this.light = GenSpawn.Spawn(Util_Projector.ProjectorLightTowerDef, position, map);
        }        
        ...
        {
            base.Draw();
            //new Vector3(0f, Altitudes.AltitudeFor(AltitudeLayer.Blueprint), 0f) + 
