...
{
    /// <summary>
    /// Building_ProjectorTurret class.
    /// </summary>
    ...
    public class Building_ProjectorTurret : Building_Projector
    {
        // ===================== Main Work Function =====================
        /// <summary>
        ...
        {
            this.light = GenSpawn.Spawn(Util_Projector.ProjectorLightTurretDef, position, map);
        }
