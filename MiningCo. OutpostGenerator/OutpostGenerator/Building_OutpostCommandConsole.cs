...
namespace OutpostGenerator
{
    ...
    public class Building_OutpostCommandConsole : Building_CommsConsole
    {
        ...
        {
            OG_Util.FactionOfMiningCo.RelationWith(Faction.OfPlayer).goodwill = -80;
            Faction.OfPlayer.RelationWith(OG_Util.FactionOfMiningCo).goodwill = -80;
            ...
            {
                Find.AttackTargetsCache.Notify_FactionHostilityChanged(Faction.OfPlayer, OG_Util.FactionOfMiningCo);
            }
        }
